    ...
    return (
        <div className="contact">
            <div className="social-media-icons">
                ...
                <a href="https://www.facebook.com/profile.php?id=100087839483211&mibextid=LQQJ4d" target="_blank" rel="noopener noreferrer">
                    <IconFacebook />
                </a>

                <a href="https://www.instagram.com/s6horses/" target="_blank" rel="noopener noreferrer">
                    <IconInstagram />
                </a>
            </div>
